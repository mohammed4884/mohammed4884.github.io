...
if (isset($_POST['insert'])) {
    ...
    $pass= $_POST["pass"];
    $dept = $_POST["dept"];
    $sql = "INSERT INTO doctor_record(user,pass,email,department)VALUES ('$fname','$pass','$email','$dept')";
...
<form class="md-form " action="" method="post" style="color: #000000; width:50%;" >

<label  for="Name">Full name</label>
<input type="text" placeholder="Doctor Name"  name="fname" id="Name" class="form-control" style="background-color:#f9f9f9 ;border-radius: 20px; margin-bottom: 15px;" required>

<label  for="Name">Password</label>
<input type="password"  name="pass" id="pass" class="form-control" style="background-color:#f9f9f9 ;border-radius: 20px; margin-bottom: 15px;" required>
...
<div class=" d-inline-block  mb-n3">
    <button class="btn btn-outline-dark btn-rounded btn-block my-3" name="insert" type="submit">ADD
